...
import static lv.neotech.tapost.config.ApplicationProperties.ApplicationProperty.BROWSER;
import static lv.neotech.tapost.config.ApplicationProperties.ApplicationProperty.ENABLE_VIDEO;
import static lv.neotech.tapost.config.ApplicationProperties.ApplicationProperty.ENABLE_VNC;
import static lv.neotech.tapost.config.ApplicationProperties.ApplicationProperty.PROXY_ENABLED;
import static lv.neotech.tapost.config.ApplicationProperties.ApplicationProperty.PROXY_HOST;
import static lv.neotech.tapost.config.ApplicationProperties.ApplicationProperty.PROXY_PORT;
import static lv.neotech.tapost.config.ApplicationProperties.ApplicationProperty.REMOTE_DRIVER;
import static lv.neotech.tapost.config.ApplicationProperties.ApplicationProperty.SELENIUM_GRID_RETRY_COUNT;
import static lv.neotech.tapost.config.ApplicationProperties.ApplicationProperty.SELENIUM_GRID_URL;
import static lv.neotech.tapost.core.DriverType.FIREFOX;
import static lv.neotech.tapost.core.DriverType.valueOf;
